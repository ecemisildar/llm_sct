...
class DeliveryShapeDetector(ColorDetector):
    ...
    def __init__(self):
        ...
        self.declare_parameter("red_object_pose", [-2.5, 3.5, 0.0])
        self.declare_parameter("green_object_pose", [0.0, -3.5, 0.0])
        self.declare_parameter("blue_object_pose", [2.5, 3.5, 0.0])
        self.declare_parameter("red_zone_pose", [-2.0, -1.5, 0.0])
